...
This is a self-contained HTML/CSS/JavaScript application that uses localStorage for simple multiplayer functionality. It works best when all players are on the same network or device (multiple browser tabs).
